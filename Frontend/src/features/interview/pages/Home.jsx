...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        try {
            ...
            if (!resumeFile) {
                alert("Please select a resume file (PDF) to generate the report.")
                return
            }
            ...
            alert(err.response?.data?.message || "Failed to generate interview strategy. Please try again.")
        }
    }
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                {selectedFileName ? (
                                    <>
                                        ...
                                        <p className='dropzone__title' style={{ color: '#10b981' }}>Uploaded</p>
